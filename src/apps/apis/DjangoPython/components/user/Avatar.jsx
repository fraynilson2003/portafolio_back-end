...
export default function Avatar() {
  ...
  return (
    <>
      <div className='flex flex-row-reverse md:flex-row bg-trans z-[150] items-center'>
          <p className='font-primary mr-2 text-sm text-font_primary'>{userApp01.username? userApp01.username : "None"}</p>
          <img 
            ref={refAvatar}
      ...
      <div ref={refOption} className={active? 'block z-[150] absolute bg-font_primary w-[120px] text-oscuro top-[45px]  md:top-[75px] md:right-0 rounded-md px-1' : "hidden"}>
          {userApp01.username? (
            <div 
